...
namespace TicariOfis.Web {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class TicariOfisAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private TicariOfis.Module.TicariOfisModule module3;
        private TicariOfis.Module.Web.TicariOfisAspNetModule module4;
        ...
        static TicariOfisAspNetApplication() {
        ...
        #endregion
        public TicariOfisAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void TicariOfisAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
